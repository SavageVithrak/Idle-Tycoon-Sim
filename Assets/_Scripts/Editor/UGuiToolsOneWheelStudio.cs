...
{
public class UGuiToolsOneWheelStudio //: MonoBehaviour
{ //https://github.com/onewheelstudio/Programming-Patterns/blob/master/Programming%20Patterns/Assets/Editor/uGUITools.cs


    private const string _hotkeyAnchorsToCorners = " %[";//в имени вместо AnchorsToCorners д.б. Ctrl+keyX или что там
    private const string _hotkeyCtrl_X = " #%@# нужен ли пробел сначала?";
